...
Every fuzz target has an associated seed corpus located in `testdata/corpus/`, which is automatically generated from the golden vectors via `scripts/gen_fuzz_corpus.go`.
